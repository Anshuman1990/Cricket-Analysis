...
public class NBmain extends BinaryClassification {
...
public void classify(ArrayList<String> data){
	Classification<String, String> classify = bayes.classify(data);
	category = classify.getCategory();
	probability = classify.getProbability();
	featureset = (ArrayList<String>) classify.getFeatureset();
}
...
public ArrayList<String> get_FeatureSet(){
	return featureset;
}
